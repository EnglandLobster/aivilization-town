...
- Make `runAgentPlanningCycle` accept optional plan progress.
...
- [ ] **Step 1: Write failing tests for immutable plan progress helpers**
...
- [ ] **Step 2: Write failing tests for dependency-aware selection**
...
- [ ] **Step 3: Write failing tests for cycle-level progress gating**
...
- [ ] **Step 4: Implement progress-aware Branch-Thinking selection**
...
- `runAgentPlanningCycle` accepts optional `planProgress` and passes it to selection.
