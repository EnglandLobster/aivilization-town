...
- Local paper extraction: `/path/to/user/AgentDev/Ai-Town/AIVILIZATION-20260623201223/AIVILIZATION.md`
- arXiv record: `https://arxiv.org/abs/2602.10429`
- arXiv HTML: `https://arxiv.org/html/2602.10429v1`

Reference-only source material:

- `/path/to/user/AgentDev/Ai-Town/a16z-ai-town`
- `/path/to/user/AgentDev/Ai-Town/generative_agents`
