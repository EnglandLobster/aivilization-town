      ...
      objectiveRenewalTraces: [
        createObjectiveRenewalTrace({
          ...
          strategicPlan: {
            ...
            observedStateSummary: 'energy=72 satiety=41 health=93 education=31',
            shortTermMemoryContext: { recordCount: 1 },
      ...
      reflectionSynthesisTraces: [
        {
          ...
          choices: [
            {
              kind: 'learning',
              topicKey: 'fish-market-pacing',
              confidence: 0.86,
              evidenceRecordIds: ['memory-1'],
            },
          ],
          worldDecisionContext: {
            agentId: 'agent-1',
      ...
      socialModelSynthesisTraces: [
        {
          ...
          reflections: [
            {
              targetAgentId: 'agent-2',
              summary: 'agent-2 shared useful market context',
              confidence: 0.81,
              evidenceRecordIds: ['social-1'],
            },
          ],
